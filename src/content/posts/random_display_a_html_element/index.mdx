...
_Updated at 2024/01/08_: I have migrated my blog from Hugo to Astro. The `replaceWith` DOM manipulation method still works. And I find [`customElement.define()`](https://developer.mozilla.org/en-US/docs/Web/API/CustomElementRegistry/define) is a more general way to implement this. The following is the snippet code:
...
<RandomOneOf>
	...
	<iframe
		style='border-radius:12px'
		src='https://open.spotify.com/embed/track/3wFLWP0FcIqHK1wb1CPthQ?utm_source=generator'
		width='100%'
		height='352'
		frameBorder='0'
		allowfullscreen=''
	...
	<iframe
		style='border-radius:12px'
		src='https://open.spotify.com/embed/track/0MMyJUC3WNnFS1lit5pTjk?utm_source=generator'
		width='100%'
		height='352'
		frameBorder='0'
		allowfullscreen=''
